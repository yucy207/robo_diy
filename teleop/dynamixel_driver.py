...
def dynamixel_cleanup_handler():
    ...
    open_clients = list(DynamixelDriver.OPEN_CLIENTS)
...
class DynamixelReader:
    ...
    def __init__(self, client: DynamixelDriver, motor_ids: Sequence[int],
...
if __name__ == '__main__':
    ...
    with DynamixelDriver(motors, parsed_args.device,
